...
public class LSGovAdapter extends ArrayAdapter<LSGovBills> {

    public LSGovAdapter(Activity context, ArrayList<LSGovBills> MemeList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LSGovBills currentAndroidFlavor = getItem(position);
